...
export class WasmChess {
  ...
  attackers(
    square: SquareStr,
    attacked_by_side?: ColorChar | null
  ): SquareStr[];
  board(): BoardState;
  /**
   ...
   */
  legalMovesVerbose(
    filter_options?: LegalMovesFilterOptions | null
  ): MoveVerbose[];
  length(): number;
  /**
...
export interface InitOutput {
  ...
  readonly wasmchess_getNags: (
    a: number,
    b: number,
    c: number
  ) => [number, number];
  readonly wasmchess_getSuffixAnnotation: (
    a: number,
    b: number,
    c: number
  ) => [number, number];
  ...
  readonly wasmchess_legalMovesVerbose: (
    a: number,
    b: number
  ) => [number, number];
  readonly wasmchess_length: (a: number) => number;
  readonly wasmchess_load: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number];
  readonly wasmchess_loadPgn: (
    a: number,
    b: number,
    c: number
  ) => [number, number];
  readonly wasmchess_move: (
    a: number,
    b: number,
    c: number
  ) => [number, number, number];
  readonly wasmchess_moveAt: (a: number, b: number) => any;
  readonly wasmchess_moveFromObj: (
    a: number,
    b: any
  ) => [number, number, number];
  ...
  readonly wasmchess_playMovesBatch: (
    a: number,
    b: number,
    c: number
  ) => [number, number, number, number];
  ...
  readonly wasmchess_removeNags: (
    a: number,
    b: number,
    c: number
  ) => [number, number];
  readonly wasmchess_removeSuffixAnnotation: (
    a: number,
    b: number,
    c: number
  ) => [number, number];
  ...
  readonly wasmchess_setSuffixAnnotation: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmchess_simulateMove: (
    a: number,
    b: number,
    c: number
  ) => [number, number, number];
